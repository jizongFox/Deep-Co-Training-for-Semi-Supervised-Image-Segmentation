...
print('->>Input args:')
pprint(parser_args)
# config_file = 'config_vat.yaml'
config_file = 'configs/config_vattrain_nat_img.yaml'
...
dataloaders = get_cityscapes_dataloaders(config['Dataset'], config['Lab_Dataloader'])
...
# dataloaders = {'lab': dataloders['train'],
